...
[StateTrackingOptions(
	...
	LogStateChanges = true,
	Description = "Component optimized for collection tracking")]
public class CollectionTrackingComponent : TrackedComponentBase {
	...
	[TrackState(
		...
		Description = "Detailed item tracking with content comparison")]
	...
	public class TrackedItem {
		...
		public override bool Equals(object? obj) {
			return obj is TrackedItem other &&
				   Name == other.Name &&
				   Value == other.Value;
		}
...
public class MixedTrackingComponent : TrackedComponentBase {
	...
	[TrackState(
		...
		Description = "Deep comparison for nested object")]
	...
	public class Level1Data {
		...
		public override bool Equals(object? obj) {
			return obj is Level1Data other &&
				   Value == other.Value &&
