...
public record ComprehensiveStressTestResults
{
    ...
    /// </summary>
    public IEnumerable<StressTestResult> AllTests => new[] 
    { 
    ...
    /// </summary>
    public double AverageOperationsPerSecond => AllTests.Any() 
        ? AllTests.Average(t => t.OperationsPerSecond) 
        : 0;
    ...
    /// </summary>
    public string OverallPerformanceRating => AverageOperationsPerSecond switch
    {
        > 1000 => "Excellent",
        > 500 => "Good",
        > 100 => "Fair", 
        ...
        string? overallError = null) => new()
    {
        ...
        OverallSuccess = string.IsNullOrEmpty(overallError) && 
                        new[] { concurrentSnapshotTest, concurrentStateChangeTest, mixedOperationsTest, memoryPressureTest, cleanupPerformanceTest }
                        .Where(t => t != null).All(t => t!.Success)
    };
    ...
    {
        var summary = $"Comprehensive Stress Test Results:\n" +
