...
public record OperationMetrics
{
    ...
    /// </summary>
    public TimeSpan AverageTime => SuccessfulOperations > 0
        ? TimeSpan.FromTicks(TotalTimeTicks / SuccessfulOperations)
        : TimeSpan.Zero;

    /// <summary>
    /// Gets the minimum operation time.
    /// </summary>
    public TimeSpan MinTime => MinTimeTicks == long.MaxValue
        ? TimeSpan.Zero
        : TimeSpan.FromTicks(MinTimeTicks);
    ...
    /// </summary>
    public TimeSpan MonitoringDuration => LastOperationTime > FirstOperationTime
        ? LastOperationTime - FirstOperationTime
        : TimeSpan.Zero;
