...
public class ReferenceComparisonStrategy : ComparisonStrategy
{
	...
	public override string GetDescription() => "Reference equality comparison for optimal performance with complex objects";
	...
	public static bool IsSuitableFor(Type type) => !type.IsValueType || (Nullable.GetUnderlyingType(type) != null);
	...
	public override string GetPerformanceCharacteristics() => "O(1) - Constant time reference comparison, fastest possible strategy";
