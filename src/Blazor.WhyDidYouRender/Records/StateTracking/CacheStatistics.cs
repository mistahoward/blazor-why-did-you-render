...
public class CacheStatistics
{
	...
	/// </summary>
	public double MaintenanceErrorRate => MaintenanceOperations > 0 ? (double)MaintenanceErrors / MaintenanceOperations : 0.0;

	/// <summary>
	/// Gets the average entries removed per maintenance operation.
	/// </summary>
	public double AverageEntriesRemovedPerMaintenance =>
		MaintenanceOperations > 0 ? (double)EntriesRemovedByMaintenance / MaintenanceOperations : 0.0;
	...
	/// </summary>
	public bool IsMaintenanceEffective =>
		MaintenanceOperations > 0 && AverageEntriesRemovedPerMaintenance > 1.0 && MaintenanceErrorRate < 0.05;
	...
	public CacheStatistics Combine(CacheStatistics other) =>
		new()
		{
	...
	{
		var summary =
			$"Cache Statistics (Performance: {PerformanceRating}):\n"
