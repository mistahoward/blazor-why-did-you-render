...
public record FieldComparisonResult
{
    ...
    /// </summary>
    public string ChangeSummary => HasChanged 
        ? $"{FieldName}: {GetValueDescription(PreviousValue)} → {GetValueDescription(CurrentValue)}"
        : $"{FieldName}: No change";
    ...
    public static FieldComparisonResult NoChange(string fieldName, object? value, string? comparisonStrategy = null) => new()
    {
        FieldName = fieldName,
        PreviousValue = value,
        CurrentValue = value,
    ...
    public static FieldComparisonResult Changed(
        ...
        string? comparisonStrategy = null) => new()
    {
        FieldName = fieldName,
    ...
    {
        var description = $"Field: {FieldName}\n" +
                         $"  Changed: {HasChanged}\n" +
    ...
    private static string GetValueDescription(object? value) => value switch
    {
        null => "null",
        string s => $"\"{s}\"",
