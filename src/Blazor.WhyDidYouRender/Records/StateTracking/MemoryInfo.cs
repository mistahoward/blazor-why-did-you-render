...
public record MemoryInfo
{
	...
	/// </summary>
	public double ActiveComponentPercentage => TotalTrackedComponents > 0 ? (double)ActiveComponents / TotalTrackedComponents * 100 : 0;

	/// <summary>
	/// Gets the average estimated memory usage per active component in bytes.
	/// </summary>
	public double AverageMemoryPerComponent => ActiveComponents > 0 ? (double)EstimatedMemoryUsage / ActiveComponents : 0;
