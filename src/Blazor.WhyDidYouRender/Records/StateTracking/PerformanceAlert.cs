...
public record PerformanceAlert
{
    ...
    public static PerformanceAlert SlowAverageTime(string operationName, TimeSpan actualTime, TimeSpan thresholdTime, AlertSeverity severity = AlertSeverity.Warning) => new()
    {
    ...
    public static PerformanceAlert SlowMaxTime(string operationName, TimeSpan actualTime, TimeSpan thresholdTime, AlertSeverity severity = AlertSeverity.Error) => new()
    {
    ...
    public static PerformanceAlert HighFailureRate(string operationName, double actualRate, double thresholdRate, AlertSeverity severity = AlertSeverity.Error) => new()
    {
    ...
    {
        var result = $"Performance Alert [{Severity}]:\n" +
