...
public record PerformanceThresholds
{
	...
	public bool IsStrict =>
		MaxAverageTime <= TimeSpan.FromMilliseconds(5) && MaxOperationTime <= TimeSpan.FromMilliseconds(50) && MaxFailureRate <= 0.01;

	/// <summary>
	/// Gets whether the thresholds are considered lenient (higher tolerance for performance issues).
	/// </summary>
	public bool IsLenient =>
		MaxAverageTime >= TimeSpan.FromMilliseconds(50) && MaxOperationTime >= TimeSpan.FromMilliseconds(500) && MaxFailureRate >= 0.10;
	...
	/// </summary>
	public static PerformanceThresholds Moderate =>
		new()
		{
	...
	/// </summary>
	public static PerformanceThresholds Lenient =>
		new()
		{
	...
	/// </summary>
	public static PerformanceThresholds Development =>
		new()
		{
	...
	/// </summary>
	public static PerformanceThresholds Production =>
		new()
		{
	...
	public bool MeetsThresholds(OperationMetrics metrics)
	{
		...
		return metrics.AverageTime <= MaxAverageTime && metrics.MaxTime <= MaxOperationTime && metrics.FailureRate <= MaxFailureRate;
	}
