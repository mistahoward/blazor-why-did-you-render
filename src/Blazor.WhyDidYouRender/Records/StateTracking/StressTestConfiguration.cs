...
public record StressTestConfiguration
{
	...
	/// </summary>
	public bool IsHighStress => ConcurrentThreads >= Environment.ProcessorCount * 2 && ComponentCount >= 500 && OperationsPerThread >= 1000;

	/// <summary>
	/// Gets predefined configuration for light stress testing.
	/// </summary>
	public static StressTestConfiguration Light =>
		new()
		{
			ComponentCount = 50,
	...
	/// </summary>
	public static StressTestConfiguration Moderate =>
		new()
		{
			ComponentCount = 100,
	...
	/// </summary>
	public static StressTestConfiguration Heavy =>
		new()
		{
			ComponentCount = 500,
	...
	/// </summary>
	public static StressTestConfiguration Extreme =>
		new()
		{
			ComponentCount = 1000,
