...
public record ThreadingConfiguration
{
	...
	/// </summary>
	public static ThreadingConfiguration LowConcurrency =>
		new()
		{
	...
	/// </summary>
	public static ThreadingConfiguration ModerateConcurrency =>
		new()
		{
	...
	/// </summary>
	public static ThreadingConfiguration HighConcurrency =>
		new()
		{
	...
	/// </summary>
	public static ThreadingConfiguration Development =>
		new()
		{
	...
	/// </summary>
	public static ThreadingConfiguration Production =>
		new()
		{
	...
	public IReadOnlyList<string> Validate()
	{
		...
		if (MaxConcurrentOperations > Environment.ProcessorCount * 10)
			issues.Add(
				$"MaxConcurrentOperations ({MaxConcurrentOperations}) is very high compared to processor count ({Environment.ProcessorCount})"
			);
	...
	public string GetFormattedSummary()
	{
		var concurrencyLevel =
			IsHighConcurrency ? "High"
			: MaxConcurrentOperations >= Environment.ProcessorCount ? "Moderate"
			: "Low";
