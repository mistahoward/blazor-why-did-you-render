...
public static class ThreadingHealthSeverityExtensions
{
	...
	public static string GetDescription(this ThreadingHealthSeverity severity) =>
		severity switch
		{
	...
	public static string GetRecommendedAction(this ThreadingHealthSeverity severity) =>
		severity switch
		{
	...
	public static string GetPriority(this ThreadingHealthSeverity severity) =>
		severity switch
		{
	...
	public static bool RequiresImmediateAttention(this ThreadingHealthSeverity severity) => severity >= ThreadingHealthSeverity.Error;
	...
	public static bool IsHealthy(this ThreadingHealthSeverity severity) => severity == ThreadingHealthSeverity.Healthy;
	...
	public static bool IsCritical(this ThreadingHealthSeverity severity) => severity == ThreadingHealthSeverity.Critical;
	...
	public static string GetColorCode(this ThreadingHealthSeverity severity) =>
		severity switch
		{
	...
	public static string GetEmoji(this ThreadingHealthSeverity severity) =>
		severity switch
		{
