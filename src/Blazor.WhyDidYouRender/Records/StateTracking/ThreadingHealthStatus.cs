...
public record ThreadingHealthStatus
{
	...
	public static ThreadingHealthStatus Healthy(ThreadingInfo? threadingInfo = null, string? context = null) =>
		new()
		{
	...
	public ThreadingHealthStatus CombineWith(ThreadingHealthStatus other)
	{
		...
		var combinedContext =
			string.IsNullOrEmpty(Context) ? other.Context
