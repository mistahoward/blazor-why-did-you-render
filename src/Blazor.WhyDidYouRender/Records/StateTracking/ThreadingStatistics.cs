...
public record ThreadingStatistics
{
	...
	public TimeSpan AverageOperationTime =>
		SuccessfulOperations > 0 ? TimeSpan.FromTicks(TotalOperationTimeTicks / SuccessfulOperations) : TimeSpan.Zero;
	...
	/// </summary>
	public double OperationsPerSecond => CollectionDuration.TotalSeconds > 0 ? TotalOperations / CollectionDuration.TotalSeconds : 0.0;

	/// <summary>
	/// Gets the ratio of cleanup operations to total operations.
	/// </summary>
	public double CleanupRatio => TotalOperations > 0 ? (double)(CleanupOperations + BulkCleanupOperations) / TotalOperations : 0.0;
	...
	public ThreadingStatistics Combine(ThreadingStatistics other) =>
		new()
		{
